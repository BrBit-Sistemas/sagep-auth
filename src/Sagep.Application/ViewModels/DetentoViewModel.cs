...
{
    public class DetentoViewModel : IEquatable<DetentoViewModel>
    {
        ...
        public bool Equals(DetentoViewModel other)
        {
            if (other is null)
                return false;
    
            return this.Nome == other.Nome && this.Ipen == other.Ipen;
        }
    
        public override bool Equals(object obj) => Equals(obj as DetentoViewModel);
        public override int GetHashCode() => (Ipen, Nome).GetHashCode();
    }
}