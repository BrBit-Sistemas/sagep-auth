    ...
    public class ViewModelToDomainMappingProfile : Profile
    {
        public ViewModelToDomainMappingProfile()
        {
            ...
            CreateMap<FormularioLeituraDicaEscritaDicaViewModel, FormularioLeituraDicaEscritaDica>()
                ...
                .ForMember(dst => dst.FormularioLeituraDicaEscritaId, src => src.MapFrom(x => x.FormularioLeituraDicaEscritaId));
            CreateMap<InfracaoAdministrativaDisciplinarViewModel, InfracaoAdministrativaDisciplinar>();
            CreateMap<InfracaoAdministrativaDisciplinarDetentoViewModel, InfracaoAdministrativaDisciplinarDetento>();
        }
    }
}
