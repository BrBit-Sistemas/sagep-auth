...
namespace Sagep.Application.AutoMapper
{
    public class DomainToViewModelMappingProfile : Profile
    {
        public DomainToViewModelMappingProfile()
        {
            ...
            CreateMap<InfracaoAdministrativaDisciplinar, InfracaoAdministrativaDisciplinarViewModel>()
                .ForMember(dst => dst.DataInfracao, src => src.MapFrom(x => x.DataInfracao.ToString("yyyy-MM-dd")));
            CreateMap<InfracaoAdministrativaDisciplinarDetento, InfracaoAdministrativaDisciplinarDetentoViewModel>();
            CreateMap<Detento, DetentoSelect2ViewModel>();
            CreateMap<ListaAmarela, DetentoViewModel>()
                .ForMember(dst => dst.Id, src => src.MapFrom(x => x.DetentoId));
        }
    }
}